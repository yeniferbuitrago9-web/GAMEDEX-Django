...
urlpatterns = [
    ...
    path('eliminar-producto-vendedor/<int:producto_id>/', views.eliminar_producto_vendedor, name='eliminar_producto_vendedor'),
    ...
    path('gestionar-usuarios/', views.lista_usuarios, name='lista_usuarios'),
